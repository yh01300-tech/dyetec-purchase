...
# 2. 인쇄 최적화 CSS (인쇄 시 데이터와 정산서 제목 외 모두 숨김)
st.markdown("""
    <style>
    @media print {
        [data-testid="stSidebar"], header, footer, .stButton, .stForm, .stRadio, 
        .stTextInput, .stSelectbox, .stDateInput, .stMetric, .stInfo, .stTitle { 
